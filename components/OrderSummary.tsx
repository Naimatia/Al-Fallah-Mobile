      ...
      <View className="bg-surface rounded-3xl p-5">
        ...
        <View className="space-y-3">
          ...
          <View className="flex-row justify-between items-center">
            ...
            <Text className="text-text-primary font-semibold text-base">
              TND{shipping.toFixed(2)}
            </Text>
          </View>

          <View className="flex-row justify-between items-center">
            <Text className="text-text-secondary text-base">Tax</Text>
            <Text className="text-text-primary font-semibold text-base">TND{tax.toFixed(2)}</Text>
          </View>
          ...
          <View className="flex-row justify-between items-center">
            ...
            <Text className="text-primary font-bold text-2xl">TND{total.toFixed(2)}</Text>
          </View>
        </View>
      </View>
    </View>
